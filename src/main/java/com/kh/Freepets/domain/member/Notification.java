...
public class Notification {
    ...
    @GeneratedValue(strategy = GenerationType.IDENTITY, generator = "notificationSeq")
    @SequenceGenerator(name = "notificationSeq", sequenceName = "SEQ_NOTIFICATION", allocationSize = 1, initialValue = 1)
