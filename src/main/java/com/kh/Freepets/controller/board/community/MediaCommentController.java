...
public class MediaCommentController {
    ...
    //미디어 게시글 한 개에 따른 댓글 전체 조회 GET - http://localhost:8080/api/community/1/comment
    ...
    //미디어 게시글 댓글 추가 POST - http://localhost:8080/api/community/comment
    ...
    //미디어 게시글 댓글 수정 UPDATE - http://localhost:8080/api/community/comment
    ...
    //미디어 게시글 댓글 삭제 DELETE - http://localhost:8080/api/community/comment/1
