...
CREATE TABLE LOST(
 ...
 LOST_YOUTUBE_URL VARCHAR2(1000),
 LOST_DATE DATE DEFAULT SYSDATE,
 LOST_VIEW_COUNT NUMBER DEFAULT 0,
 LOST_DESC VARCHAR2(1000),
 LOST_LIKE_COUNT NUMBER DEFAULT 0,
...
ALTER TABLE LOST ADD CONSTRAINT LOST_CODE_FK FOREIGN KEY(ID) REFERENCES MEMBER;
ALTER TABLE LOST_LIKE ADD CONSTRAINT LOST_LIKE_CODE_FK FOREIGN KEY (LOST_CODE)REFERENCES LOST ON DELETE SET NULL;
ALTER TABLE LOST_LIKE ADD CONSTRAINT LOST_LIKE_CODE_FK FOREIGN KEY(ID) REFERENCES MEMBER;
ALTER TABLE LOST_COMMENT ADD CONSTRAINT L_COMMENT_CODE_FK FOREIGN KEY (LOST_CODE)REFERENCES LOST ON DELETE SET NULL;
ALTER TABLE LOST_COMMENT ADD CONSTRAINT L_COMMENT_CODE_FK FOREIGN KEY(ID) REFERENCES MEMBER;
...
ALTER TABLE SITTER ADD CONSTRAINT SITTER_ID_FK FOREIGN KEY(ID) REFERENCES MEMBER(ID);
ALTER TABLE SITTER_REVIEW ADD CONSTRAINT SITTER_REVIEW_ID_FK FOREIGN KEY(ID) REFERENCES MEMBER(ID);
ALTER TABLE SITTER_REVIEW ADD CONSTRAINT SITTER_REVIEW_SITTER_CODE FOREIGN KEY (SITTER_CODE) REFERENCES SITTER (SITTER_CODE) ON DELETE SET NULL;
...
ALTER TABLE COMMON_LIKE ADD FOREIGN KEY(C_LIKE_CODE) REFERENCES COMMON_LIKE(C_LIKE_CODE) ON DELETE SET NULL;
...
ALTER TABLE COMMON_LIKE ADD FOREIGN KEY (C_LIKE_CODE) REFERENCES COMMON(COMMON_CODE) ON DELETE CASCADE;
...
ALTER TABLE HR_COMMENT ADD CONSTRAINT HR_COMMENT_HOSPITAL_REVIEW_CODE FOREIGN KEY(HOSPITAL_REVIEW_CODE) REFERENCES HOSPITAL_REVIEW(HOSPITAL_REVIEW_CODE) ON DELETE CASCADE;

ALTER TABLE HR_LIKE ADD CONSTRAINT HR_LIKE_ID_FK FOREIGN KEY(ID) REFERENCES MEMBER;
ALTER TABLE HR_LIKE ADD CONSTRAINT HR_LIKE_HOSPITAL_REVIEW_CODE FOREIGN KEY(HOSPITAL_REVIEW_CODE) REFERENCES HOSPITAL_REVIEW(HOSPITAL_REVIEW_CODE) ON DELETE CASCADE;
------------------------------------------------------------------------------------------------------------------------------
