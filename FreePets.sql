...
ALTER TABLE LOST_LIKE ADD FOREIGN KEY(LOST_LIKE_CODE) REFERENCES LOST_LIKE(LOST_LIKE_CODE) ON DELETE SET NULL;
ALTER TABLE LOST ADD LOST_YOUTUBE_URL VARCHAR2(1000);
ALTER TABLE LOST ADD LOST_LIKE_COUNT NUMBER DEFAULT 0;
ALTER TABLE LOST ADD LOST_VIEW_COUNT NUMBER DEFAULT 0;
ALTER TABLE LOST DROP COLUMN LOST_VIEWS;
ALTER TABLE LOST DROP COLUMN LOST_LIKE;
...
ALTER TABLE HR_COMMENT ADD FOREIGN KEY(HOSPITAL_REVIEW_CODE) REFERENCES HOSPITAL_REVIEW(HOSPITAL_REVIEW_CODE) ON DELETE SET NULL;
ALTER TABLE HR_LIKE ADD FOREIGN KEY(HOSPITAL_REIVEW_CODE) REFERENCES HOSPITAL_REVIEW(HOSPITAL_REVIEW_CODE) ON DELETE SET NULL;
