...
ALTER TABLE NOTICE_LIKE ADD CONSTRAINT NOTICE_LIKE_CODE_FK FOREIGN KEY (NOTICE_CODE)REFERENCES NOTICE;
ALTER TABLE NOTICE_LIKE ADD CONSTRAINT NOTICE_LIKE_ID_FK FOREIGN KEY(ID) REFERENCES MEMBER;

ALTER TABLE NOTICE_COMMENT ADD CONSTRAINT NOTICE_COMMENT_CODE_FK FOREIGN KEY (NOTICE_CODE)REFERENCES NOTICE;
